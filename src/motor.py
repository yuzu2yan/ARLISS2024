...
class Motor(object):
    ...
    def turn_right(self):
        Motor.pi.set_PWM_dutycycle(FRONT[1], 100) # Left
        Motor.pi.set_PWM_dutycycle(FRONT[0], 35) # Right
        [Motor.pi.set_PWM_dutycycle(pin, 0) for pin in REAR]
        print("turn right")
    
    def turn_left(self):
        Motor.pi.set_PWM_dutycycle(FRONT[1], 25) # Left
        Motor.pi.set_PWM_dutycycle(FRONT[0], 100) # Right
        [Motor.pi.set_PWM_dutycycle(pin, 0) for pin in REAR]
        print("turn left")
        
    def turn_here(self):
        Motor.pi.set_PWM_dutycycle(FRONT[1], 10) # Left
        Motor.pi.set_PWM_dutycycle(FRONT[0], 0) # Right
        Motor.pi.set_PWM_dutycycle(REAR[1], 0) # Left
        Motor.pi.set_PWM_dutycycle(REAR[0], 10) # Right
